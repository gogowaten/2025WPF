...
namespace _20250416
{
    ...
    {
        public PointCollection MyInternalPoints { get; set; } = new PointCollection();
        public GeoShape()
        {
        ...
        {
            Initialized += GeoShape_Initialized;
            Loaded += GeoShape_Loaded;
            //Pointsの始点と終点を外したPointCollection。始点と終点以外の線の描画に使う
            //このバインドの設定はLoadedでは遅いようで正しく描画されないのでここで行っている
        ...
        private void GeoShape_Initialized(object? sender, EventArgs e)
        {

            for (int i = 0; i < MyPoints.Count; i++)
            {
                MyInternalPoints.Add(MyPoints[i]);
            }
        ...
        {
            var bind = new MultiBinding() { Converter = new MyConvRenderTransform3() };
            bind.Bindings.Add(MakeOneWayBind(MyScaleTransformProperty));
            bind.Bindings.Add(MakeOneWayBind(MyRotateTransformProperty));
        ...
        //public PointCollection MyInternalPoints
        //{
        //    get { return (PointCollection)GetValue(MyInternalPointsProperty); }
        //    set { SetValue(MyInternalPointsProperty, value); }
        //}
        //public static readonly DependencyProperty MyInternalPointsProperty =
        //    DependencyProperty.Register(nameof(MyInternalPoints), typeof(PointCollection), typeof(GeoShape),
    ...
    public class MyConvRenderTransform3 : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
