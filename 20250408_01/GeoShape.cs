...
namespace _20250408_01
{
    ...
    //回転指定で、全てのPoint座標を回転する
    //拡大指定で、全てのPoint座標を拡大後のものにする、StrokeThicknessも拡大する
    //無理
    ...
    public class GeoShape : Shape
    {
        ...
        {
            var mb = new MultiBinding() { Converter = new MyConvStrokeThicknessScale() };
            mb.Bindings.Add(new Binding(nameof(MyStrokeThicknessScaleKiso)) { Source = this });
            mb.Bindings.Add(MakeOneWayBind(MyStrokeThicknessScaleProperty));
            SetBinding(StrokeThicknessProperty, mb);
        }
        ...
        public double MyAngle2
        {
            get { return (double)GetValue(MyAngle2Property); }
            set { SetValue(MyAngle2Property, value); }
        }
        public static readonly DependencyProperty MyAngle2Property =
            DependencyProperty.Register(nameof(MyAngle2), typeof(double), typeof(GeoShape), new PropertyMetadata(0.0));
