...
namespace _20250611
{
    ...
    public class GeoShape : Shape
    {
        ...
        public List<PointCollection> MyPointsList
        {
            get { return (List<PointCollection>)GetValue(MyPointsListProperty); }
            set { SetValue(MyPointsListProperty, value); }
        }
        public static readonly DependencyProperty MyPointsListProperty =
            DependencyProperty.Register(nameof(MyPointsList), typeof(List<PointCollection>), typeof(GeoShape),
